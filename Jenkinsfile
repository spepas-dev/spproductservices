namespace = "default"
serviceName = "spepas-product"
service = "Spepas Product"
...
pipeline {
  ...
  environment {
    ...
    IMAGE_NAME = "jboadi" + "/" + "spepas-product"
  ...
  stages {
    ...
    stage("Prepare Environment") {
      steps {
        ...
        git branch: 'main', credentialsId: 'github', url: 'https://github.com/spepas-dev/spproductservices'
        sh 'npm install'
      }
    }
